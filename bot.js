...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['made by mania','Type xtra bot 404'];
    var i = -1;
    var j = 0;
...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By Mania
    let pages = [`**
        ***__الاوامر العامة__***
**
${prefix}bots/لعرض جميع البوتات الي بالسيرفر
...
${prefix}inviteinfo <invitelink here> / لمعلومات عن الدعوه
 مثال : invinfo m82n8P
${prefix}invite-codes/يعرض لك روابط الانفايتات حكك في السيرفر 
${prefix}cal/اله حاسبة
${prefix}tras <language> <any thing>/يترجم لك الي تبيه من اي لغة
...
${prefix}sa/يكرر الي تقولو بشكل حلو
${prefix}emo <any things>/لتحويل اي كلمه تقولها الي ايموجي
...
${prefix}hidec / اخفاء الشات
${prefix}showc/ اضهار الشات المخفية
...
${prefix}addc <number> / ينشا لك الوان مع كم الوان تبي
${prefix}color <number> / لختيار لون
${prefix}dcolors <number> / لحذف الالوان
**
   `,`
        ***__الميوزك__***
**
